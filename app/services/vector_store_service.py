...
class FAISSVectorStoreService(VectorStoreService):
    ...
    def __init__(self, storage_path: str = None):
        ...
        # PHASE 1 FIX: Increased chunk limits for richer context and better responses
        self.MAX_CHUNKS_PER_TYPE = 4  # PHASE 1: Increased from 2 to 4 for better coverage per document type
        self.MAX_TOTAL_CHUNKS = 6     # PHASE 1: Increased from 3 to 6 for more comprehensive context
