...
"""
    ...
    def test_get_document_type_metadata(self):
        ...
        assert financial_meta["recommended_chunk_size"] == 500
        assert financial_meta["recommended_overlap"] == 50
        ...
        assert long_form_meta["recommended_chunk_size"] == 1500
        assert long_form_meta["recommended_overlap"] == 300
        assert long_form_meta["processing_priority"] == "semantic"
        
        # Test generic metadata
        generic_meta = get_document_type_metadata("generic")
        assert generic_meta["recommended_chunk_size"] == 1000
        assert generic_meta["recommended_overlap"] == 200
